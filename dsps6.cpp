...
class PizzaOrder { private: int front, rear, capacity; int *orderQueue;
...
int main() { int m, ch, orderId; cout << "Enter Pizza Parlor's Maximum Order Capacity: "; cin >> m; PizzaOrder P(m);
